...
export function EventDescription({ event }) {
  ...
  return (
    <section className="space-y-6">
      <Card className="bg-white border-gray-200 shadow-2xl shadow-slate-950/60 backdrop-blur-xl rounded-2xl pt-6">
        ...
        <CardContent className="space-y-6 text-sm text-black">
          ...
          {event.timeSlots && event.timeSlots.length > 0 && (
            <div className="pt-5 border-t border-gray-200">
              <h3 className="text-sm font-semibold text-black mb-3">Event Schedule</h3>
